...
namespace clothing_store.DAL.Models
{
    public partial class OnlineStoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=.\\MNV;Initial Catalog=OnlineStore;Persist Security Info=True;User ID=sa;Password=diosvo0321;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True;");
            }
        }
